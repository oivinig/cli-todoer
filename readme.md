...
This is a CLI tool that can be used to manage TODOs in the terminal.  
The basic usage of the tool is going to look like this:
...
//TODO: create installation process docs
